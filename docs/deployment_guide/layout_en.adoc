...
:!toc:
[.text-left]
include::partner_editable/introduction.adoc[]

== Overview
include::partner_editable/overview.adoc[]
...
include::partner_editable/product_description.adoc[]
ifndef::production_build[]
|===
endif::production_build[]

== Cost
include::partner_editable/cost.adoc[]
...
include::{specificdir}/planning_deployment.adoc[]

== Deployment options
include::{specificdir}/deployment_options.adoc[]

== Deployment steps
include::{specificdir}/deployment_steps.adoc[]
...
Visit our https://github.com/aws-quickstart/{quickstart-project-name}[GitHub repository^] to download the templates and scripts for this Quick Start, post your comments, and share your customizations with others.